...
if (!navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|nexus 7)/i)) {
   ...
   window.addEventListener('mousemove',function(e) {
     ...
     $('.logo').css('text-shadow', calculateShadows(baseX/(window.innerWidth / 2),baseY/(window.innerHeight / 2)));
   ...
   window.addEventListener('deviceorientation',function(e){
      ...
      $('.logo').css('text-shadow', calculateShadows(baseX/sensitivity,baseY/sensitivity));
